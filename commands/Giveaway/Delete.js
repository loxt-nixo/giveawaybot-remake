...
module.exports = {
    ...
    execute: async function (interaction, client) {
        ...
        const Channel = client.channels.cache.get(giveawayData.Channel);
        const Message = await Channel.messages.fetch(giveawayData.Message);

        await Message.delete();
        await client.schemas.giveaways.deleteOne({ Message: giveawayData.Message, Channel: giveawayData.Channel });

        interaction.reply({ content: `🎉 Successfully deleted giveaway ${giveaway}!`, ephemeral: true })
    }
}